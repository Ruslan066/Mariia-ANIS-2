...
public class Flowers extends Feature implements Serializable, Item {
    private final int id;
    private final String name;
    private int count;
    private double cost;

    public Flowers(int id, String name, double cost) {
        this.id = id;
        this.name = name;
        this.cost = cost;
        this.count = 10;
    }
    public Flowers(int id, String name, double cost, int count) {
        this.id = id;
        this.name = name;
        this.cost = cost;
        this.count = count;
